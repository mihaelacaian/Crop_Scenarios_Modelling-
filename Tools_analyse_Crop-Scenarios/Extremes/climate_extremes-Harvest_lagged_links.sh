...
## lagged links in climate scenarios

cat << eof1 > compare_lagged_extremes_Harvest-precip.gs
...
#######################
#
## lagged links in Observed climate 

cat << eof2 > extreme-PP_Harvest_link.gs
